...
def send_account_creation_email(request, reciepients: list, context: dict = {}, is_trial: bool = False) -> bool:
  """
  ...
  """
  try:
    subject = "Account Created" if not is_trial else "Trial Account Created"
